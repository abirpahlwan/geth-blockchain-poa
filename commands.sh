...
clef --keystore ./node_01/keystore --configdir ./clef --chainid 12345 --suppress-bootwarn init
clef --keystore ./node_01/keystore --configdir ./clef --chainid 12345 --suppress-bootwarn setpw 0x08A427De46773b907a9C406F81948Aa22D2D3260
clef --keystore ./node_01/keystore --configdir ./clef --chainid 12345 --suppress-bootwarn --nousb
...
geth --datadir ./node_01 --signer ./clef/clef.ipc console
...
eth.sendTransaction({  to: '0x528EA91FA33F1C194E176929F22Adda8e4687d82',  from: eth.accounts[0],  value: 100000000000000000000000000000000 });
var tx = { from: '0x08a427de46773b907a9c406f81948aa22d2d3260', to: '0x528EA91FA33F1C194E176929F22Adda8e4687d82', value: 100000000000000000000000000000000 };
